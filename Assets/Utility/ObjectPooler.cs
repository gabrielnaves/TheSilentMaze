...
public class ObjectPooler : MonoBehaviour {
	...
	public bool disablePooledObjectOnStart;
    ...
    /// <summary> Returns an object if possible, and sets position and rotation. </summary>
    /// This method will not activate the object before returning it.
	...
	void Start() {
		if (pooledObject == null)
			Debug.LogError("[" + this + "]Start: No pooled object given.");
		else
			InitPool();
	}

	private void InitPool() {
		if (disablePooledObjectOnStart)
